...
export async function GET() {
  try {
    ...
    const rows = await db.$queryRaw<Array<{
      ...
      latitude: number | null; longitude: number | null; locationSource: string | null; device: string | null; browser: string | null; os: string | null; referrer: string | null
      firstSeenAt: Date; lastSeenAt: Date
    }>>`
      SELECT v."sessionId", v."userId", u."name", v."path", v."country", v."city", v."region",
             v."latitude", v."longitude", v."locationSource", v."device", v."browser", v."os", v."referrer",

...
const capabilities = [
  ...
  { key: 'inventory.transfers', name: 'Transfers', state: 'ready', scope: ['draft', 'in transit', 'receiving', 'movement records'] },
  { key: 'inventory.purchase-orders', name: 'Purchase orders', state: 'ready', scope: ['supplier procurement', 'costing', 'receiving foundation'] },
  { key: 'orders.core', name: 'Orders', state: 'ready', scope: ['checkout orders', 'manual orders', 'status lifecycle', 'tracking', 'notes', 'audit'] },
  { key: 'orders.drafts', name: 'Draft orders', state: 'ready', scope: ['draft creation', 'editing', 'completion', 'cancel'] },
  { key: 'orders.fulfillment', name: 'Fulfillment', state: 'ready', scope: ['fulfillment records', 'partial lines', 'tracking', 'shipping lifecycle'] },
  { key: 'orders.edits', name: 'Order edits', state: 'ready', scope: ['editable order delta', 'reason', 'audit'] },
  ...
  { key: 'orders.gift-cards', name: 'Gift cards', state: 'ready', scope: ['issue', 'balance adjustment', 'status', 'expiry'] },
  { key: 'customers', name: 'Customers', state: 'ready', scope: ['profiles', 'addresses', 'orders', 'reviews', 'activation'] },
  { key: 'customers.tags', name: 'Customer tags', state: 'ready', scope: ['tag creation', 'membership assignment'] },
  { key: 'customers.segments', name: 'Customer segments', state: 'ready', scope: ['segment definitions', 'membership assignment'] },
  ...
  { key: 'integrations.webhooks', name: 'Webhooks', state: 'ready', scope: ['topics', 'HTTPS endpoints', 'secret management', 'status'] },
  { key: 'integrations.api-credentials', name: 'API credentials', state: 'ready', scope: ['scoped keys', 'hash storage', 'expiry', 'revocation'] },
  { key: 'sales-channels', name: 'Sales channels', state: 'ready', scope: ['channel records', 'publication foundation'] },

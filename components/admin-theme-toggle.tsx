...
export default function AdminThemeToggle() {
  ...
  return (
    <>
      <style jsx global>{`
        html[data-admin-theme='dark'] body:has(.adminShell){background:#111312!important;color:#f2f4f2!important}
        html[data-admin-theme='dark'] body:has(.adminShell) .adminShell{background:#111312!important}
        html[data-admin-theme='dark'] body:has(.adminShell) .adminSide{background:#171918!important;border-color:#292d2a!important;color:#f2f4f2!important}
        html[data-admin-theme='dark'] body:has(.adminShell) .adminMain{color:#f2f4f2!important}
        html[data-admin-theme='dark'] body:has(.adminShell) .adminTopbar{background:rgba(17,19,18,.88)!important;border-color:#292d2a!important}
        ...
        html[data-admin-theme='dark'] body:has(.adminShell) .catalogHead .h2{color:#f4f6f4!important}
        html[data-admin-theme='dark'] body:has(.adminShell) .muted,
        html[data-admin-theme='dark'] body:has(.adminShell) .tiny,
        html[data-admin-theme='dark'] body:has(.adminShell) .fieldHelp{color:#9ca59f!important}
        ...
        html[data-admin-theme='dark'] body:has(.adminShell) .adminNavGroupButton.active{background:#232724!important;color:#f4f6f4!important}
        ...
        html[data-admin-theme='dark'] body:has(.adminShell) .adminNavItem.active{background:#2a2e2b!important;color:#fff!important;box-shadow:inset 3px 0 0 #8fe0b2!important}
        ...
        html[data-admin-theme='dark'] body:has(.adminShell) .successCard{background:#191c1a!important;border-color:#2b302c!important;color:#e9edea!important;box-shadow:0 8px 26px rgba(0,0,0,.22)!important}

...
const labels: Array<[string, string]> = [
  ...
  ['/admin/online-store', 'Online Store'],
    ...
    <header className="adminWorkspaceTopbar">
      <div className="adminWorkspaceTitle">
        <div className="adminBreadcrumbs">
          <Link href="/admin" className="adminBreadcrumbHome" aria-label="Dashboard"><Home size={13} /></Link>
      ...
      <div className="adminWorkspaceActions">
        <button type="button" className="adminTopSearch" onClick={() => document.getElementById('admin-nav-search')?.focus()} title="Search admin navigation">
      ...
      <style jsx>{`
        ...
        .adminWorkspaceTitle{min-width:0}.adminBreadcrumbs{display:flex;align-items:center;gap:5px;color:#85857e;font-size:11px;font-weight:700}.adminBreadcrumbHome{display:grid;place-items:center;color:#777770}.adminWorkspaceTitle h1{margin:5px 0 0;font-size:27px;line-height:1;letter-spacing:-.035em;color:#191a18}

  ...
  return (
    <header className="adminWorkspaceTopbar">
      ...
      <div className="adminWorkspaceActions">
        ...
        <div className="adminTopTheme"><AdminThemeToggle compact /></div>
      ...
      <style jsx>{`
        ...
        @media(max-width:560px){.adminWorkspaceTopbar{min-height:66px;margin-bottom:18px;gap:10px}.adminWorkspaceTitle h1{font-size:20px}.adminTopSearch{width:36px;height:36px;flex-basis:36px}.adminTopIconLink{width:36px;height:36px;min-width:36px;flex-basis:36px}.adminTopAvatar{width:32px;min-width:32px;height:32px;flex-basis:32px}}
        html[data-admin-theme='dark'] .adminWorkspaceTopbar{background:rgba(16,18,17,.9)!important;border-color:#2a2f2c!important}
      `}</style>
    </header>
  )
}
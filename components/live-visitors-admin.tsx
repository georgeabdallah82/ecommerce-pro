...
export default function LiveVisitorsAdmin() {
  ...
  return (
    <section className="liveVisitors">
      <style jsx global>{`.liveVisitors{margin-top:52px;display:grid;gap:18px}.liveVisitors .lv-header{display:flex;align-items:flex-end;justify-content:space-between;gap:22px}.liveVisitors .lv-kicker{display:inline-flex;align-items:center;gap:7px;font-size:11px;letter-spacing:.11em;text-transform:uppercase;font-weight:900;color:#176b35}.liveVisitors .lv-live-dot{width:7px;height:7px;border-radius:99px;background:#16a34a;box-shadow:0 0 0 5px rgba(22,163,74,.1)}.liveVisitors .lv-title{margin:9px 0 4px;font-size:34px;line-height:1.05;letter-spacing:-.04em}.liveVisitors .lv-subtitle{margin:0;max-width:760px;color:var(--muted);font-size:14px;line-height:1.65}.liveVisitors .lv-actions{display:flex;gap:8px;flex-wrap:wrap;justify-content:flex-end}.liveVisitors .lv-btn{display:inline-flex;align-items:center;justify-content:center;gap:8px;min-height:40px;padding:0 13px;border:1px solid var(--line);border-radius:11px;background:#fff;color:var(--ink);font-size:13px;font-weight:800;cursor:pointer;box-shadow:0 2px 6px rgba(23,23,23,.04)}.liveVisitors .lv-btn:hover{background:var(--soft)}.liveVisitors .lv-btn:disabled{opacity:.5;cursor:not-allowed}.liveVisitors .lv-btn.active{background:var(--ink);border-color:var(--ink);color:#fff}.liveVisitors .lv-error{padding:12px 14px;border:1px solid #ffd1cd;border-radius:14px;background:#fff5f4;color:#9a2418;font-size:13px}.liveVisitors .lv-stats{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}.liveVisitors .lv-stat{min-height:112px;padding:18px;border:1px solid var(--line);border-radius:18px;background:#fff;box-shadow:0 6px 18px rgba(23,23,23,.04)}.liveVisitors .lv-stat-top{display:flex;align-items:center;justify-content:space-between;color:var(--muted);font-size:12px;font-weight:800}.liveVisitors .lv-stat-icon{display:grid;width:34px;height:34px;place-items:center;border-radius:10px;background:var(--soft);color:var(--ink)}.liveVisitors .lv-stat-value{margin-top:11px;font-size:28px;line-height:1;letter-spacing:-.04em;font-weight:900}.liveVisitors .lv-stat-hint{margin-top:8px;font-size:11px;color:var(--muted)}.liveVisitors .lv-main{display:grid;grid-template-columns:minmax(0,1.65fr) minmax(320px,.75fr);gap:14px;align-items:start}.liveVisitors .lv-side{border:1px solid var(--line);border-radius:22px;background:#fff;box-shadow:0 10px 28px rgba(23,23,23,.05);overflow:hidden}.liveVisitors .lv-side-head{padding:17px 17px 14px;border-bottom:1px solid var(--line)}.liveVisitors .lv-side-title{display:flex;align-items:center;justify-content:space-between;gap:12px}.liveVisitors .lv-side-title h3{margin:0;font-size:15px;letter-spacing:-.01em}.liveVisitors .lv-side-count{padding:4px 8px;border-radius:99px;background:var(--soft);font-size:11px;font-weight:800}.liveVisitors .lv-search{position:relative;margin-top:12px}.liveVisitors .lv-search svg{position:absolute;left:11px;top:50%;transform:translateY(-50%);color:var(--muted)}.liveVisitors .lv-search input{width:100%;height:39px;border:1px solid var(--line);border-radius:10px;background:#fafaf8;padding:0 12px 0 34px;outline:0;font-size:12px}.liveVisitors .lv-search input:focus{border-color:#bbb;box-shadow:0 0 0 3px rgba(23,23,23,.06)}.liveVisitors .lv-list{max-height:505px;overflow:auto}.liveVisitors .lv-row{display:grid;grid-template-columns:36px minmax(0,1fr) auto;gap:10px;width:100%;padding:13px 15px;border:0;border-bottom:1px solid #f0f0ec;background:#fff;text-align:left;cursor:pointer}.liveVisitors .lv-row:hover{background:#fafaf8}.liveVisitors .lv-row.selected{background:#f3f3ef;box-shadow:inset 3px 0 0 var(--ink)}.liveVisitors .lv-avatar{display:grid;width:36px;height:36px;place-items:center;border-radius:11px;background:var(--soft);font-size:11px;font-weight:900}.liveVisitors .lv-row-main{min-width:0}.liveVisitors .lv-row-top{display:flex;align-items:center;gap:7px;min-width:0}.liveVisitors .lv-row-name{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:900}.liveVisitors .lv-row-status{width:6px;height:6px;flex:0 0 6px;border-radius:99px;background:#16a34a}.liveVisitors .lv-row-page{display:block;margin-top:4px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--muted);font-size:11px}.liveVisitors .lv-row-location{display:flex;align-items:center;gap:5px;margin-top:5px;overflow:hidden;color:var(--ink);font-size:11px}.liveVisitors .lv-row-location span:last-child{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.liveVisitors .lv-row-meta{display:flex;flex-direction:column;align-items:flex-end;gap:6px;color:var(--muted);font-size:10px}.liveVisitors .lv-row-meta .inline{display:inline-flex;align-items:center;gap:5px}.liveVisitors .lv-badge{display:inline-flex;align-items:center;gap:5px;padding:4px 7px;border:1px solid var(--line);border-radius:999px;background:#fff;font-size:9px;font-weight:900;white-space:nowrap}.liveVisitors .lv-empty{padding:40px 20px;text-align:center;color:var(--muted);font-size:12px}.liveVisitors .lv-detail{border:1px solid var(--line);border-radius:22px;background:#fff;padding:18px;box-shadow:0 10px 28px rgba(23,23,23,.05)}.liveVisitors .lv-detail-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.liveVisitors .lv-detail-person{display:flex;align-items:center;gap:12px}.liveVisitors .lv-detail-avatar{display:grid;width:44px;height:44px;place-items:center;border-radius:13px;background:var(--soft);font-size:13px;font-weight:900}.liveVisitors .lv-detail-label{font-size:10px;font-weight:900;text-transform:uppercase;letter-spacing:.08em;color:var(--muted)}.liveVisitors .lv-detail-name{margin:3px 0 0;font-size:18px;font-weight:900;letter-spacing:-.02em}.liveVisitors .lv-detail-close{display:grid;width:34px;height:34px;place-items:center;border:1px solid var(--line);border-radius:10px;background:#fff;cursor:pointer}.liveVisitors .lv-detail-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;margin-top:18px}.liveVisitors .lv-detail-item{padding:12px;border-radius:13px;background:var(--soft)}.liveVisitors .lv-detail-value{margin-top:5px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:800}.liveVisitors .lv-detail-actions{display:flex;gap:8px;flex-wrap:wrap;margin-top:14px;align-items:center}.liveVisitors .lv-primary{display:inline-flex;align-items:center;gap:7px;min-height:38px;padding:0 12px;border-radius:10px;border:1px solid var(--ink);background:var(--ink);color:#fff;font-size:11px;font-weight:800}.liveVisitors .lv-note{margin:12px 0 0;color:var(--muted);font-size:10px;line-height:1.6}@media(max-width:1100px){.liveVisitors .lv-main{grid-template-columns:1fr}.liveVisitors .lv-list{max-height:380px}.liveVisitors .lv-stats{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:720px){.liveVisitors .lv-header{align-items:flex-start;flex-direction:column}.liveVisitors .lv-actions{justify-content:flex-start}.liveVisitors .lv-title{font-size:29px}.liveVisitors .lv-stats{grid-template-columns:1fr 1fr}.liveVisitors .lv-detail-grid{grid-template-columns:1fr 1fr}}@media(max-width:480px){.liveVisitors .lv-stats{grid-template-columns:1fr}.liveVisitors .lv-detail-grid{grid-template-columns:1fr}.liveVisitors .lv-row{grid-template-columns:34px minmax(0,1fr)}.liveVisitors .lv-row-meta{display:none}}
      `}</style>

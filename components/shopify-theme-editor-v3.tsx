...
import { ArrowDown, ArrowLeft, Copy, Eye, GripVertical, Image as ImageIcon, Monitor, Palette, Plus, Redo2, Save, Search, Settings2, Smartphone, Tablet, Trash2, Undo2, X } from 'lucide-react'

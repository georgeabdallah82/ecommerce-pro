...
function ProductCard({p,theme,onQuickView,preview,onSelect,wishlist,toggleWish}:{p:AnyMap;theme:AnyMap;onQuickView:(p:AnyMap)=>void;preview?:boolean;onSelect?:()=>void;wishlist?:Record<string,boolean>;toggleWish?:(id:string)=>void}){

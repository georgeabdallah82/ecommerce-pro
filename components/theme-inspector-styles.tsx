...
.themeInspector{padding:14px;display:grid;gap:10px;background:var(--admin-bg)}
.themeInspectorPanel{border:1px solid var(--admin-border);border-radius:var(--admin-radius-md);background:var(--admin-surface);overflow:hidden}
...
.themeInspectorPanel>div{padding:14px;display:grid;gap:12px}
.themeInspectorField{display:grid;gap:5px}
.themeInspectorField>span,.themeInspectorRange span{font-size:10px;font-weight:800;letter-spacing:.05em;text-transform:uppercase;color:var(--admin-muted)}
...
.themeInspectorGrid{display:grid;grid-template-columns:1fr 1fr;gap:10px}
...
.themeBlock{border:1px solid var(--admin-border);border-radius:var(--admin-radius-sm);background:var(--admin-surface);overflow:hidden}
.themeBlockHeader{display:flex;align-items:center;gap:8px;padding:9px 10px;border-bottom:1px solid var(--admin-border-soft);font-size:11px;color:var(--admin-muted)}
.themeBlockHeader strong{flex:1;color:var(--admin-ink)}
...
.themeBlockFields{padding:10px;display:grid;gap:10px}

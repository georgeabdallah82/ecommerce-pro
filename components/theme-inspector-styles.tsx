...
html[data-admin-theme='dark'] .themeImageThumb{border-color:#343b36;background:#191d1b}
html[data-admin-theme='dark'] .themeImageActions button{border-color:#343b36;background:#191d1b;color:#eef2ef}
html[data-admin-theme='dark'] .themeImageActions button:hover{border-color:#8a9891}
html[data-admin-theme='dark'] .themeImageEmpty{border-color:#3a4238;background:#191d1b;color:#9da69f}
html[data-admin-theme='dark'] .themeImageEmpty:hover{border-color:#eef2ef;color:#eef2ef}
`}}/>
}
